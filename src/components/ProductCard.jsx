export default function ProductCard({onClick, product})
{
    ...
    <div key={product.key} onClick={onClick} className="max-w-xs min-h-[370px] flex flex-col bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 cursor-pointer">
        ...
        <div className="p-5 flex flex-col flex-grow justify-between">
            ...
            <div className="bg-orange-100 px-[4px] w-fit min-h-[24px]">
            ...
            <button type="button" className="w-full cursor-pointer text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700" onClick={onClick}>SHOW DETAIL</button>
        </div>
    </div>
    )
}